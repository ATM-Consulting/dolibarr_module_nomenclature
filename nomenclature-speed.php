...
function _drawlines(&$object, $object_type) {
	...
	<div style="text-align: left;">
		<div class="inline-block divButAction"><a href="nomenclature-detail.php?id=<?php echo GETPOST('id') ?>&token=<?php echo $newToken; ?>&object=<?php echo GETPOST('object') ?>" class="butAction">Liste produits et MO nécessaires</a></div>
